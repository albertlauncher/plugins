...
RoundedRect::RoundedRect(QWidget *parent):
    QWidget(parent),
...
double RoundedRect::borderWidth() const
{
    return border_width_;
}

void RoundedRect::setBorderWidth(double boarderWidth)
{
...
double RoundedRect::radius() const
{
    return radius_;
}

void RoundedRect::setRadius(double radius)
{
    if (radius_ == radius)
        return;
...
QBrush RoundedRect::fillBrush() const
{
    return fill_brush_;
}

void RoundedRect::setFillBrush(QBrush fillBrush)
{
...
QBrush RoundedRect::borderBrush() const
{
    return border_brush_;
}

void RoundedRect::setBorderBrush(QBrush boarderBrush)
{
...
void RoundedRect::paintEvent(QPaintEvent*)
{
...
// void RoundedRect::setStyle(const Style *s)
// {
//     style_ = s;
